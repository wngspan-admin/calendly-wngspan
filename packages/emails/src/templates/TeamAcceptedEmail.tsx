...
export const TeamAcceptedEmail = (
  props: TeamAccepted & Partial<React.ComponentProps<typeof V2BaseEmailHtml>>
) => {
  return (
    <V2BaseEmailHtml
      subject={props.language("email_team_accepted|subject", {
        memberName: props.memberName,
        teamName: props.teamName,
      })}>
      <p style={{ fontSize: "24px", marginBottom: "16px", textAlign: "center" }}>
        <>
          {props.language("email_team_accepted|heading", {
            teamName: props.teamName,
          })}
        </>
      </p>
      ...
      <p
        ...
        <>
          {props.language("email_team_accepted|content", {
            memberName: props.memberName,
            teamName: props.teamName,
            appName: APP_NAME,
          })}
