...
import { ZAdminDeleteOrganizationSchema } from "./deleteOrganization.schema";
...
export const adminRouter = router({
  ...
  deleteOrganization: authedAdminProcedure.input(ZAdminDeleteOrganizationSchema).mutation(async (opts) => {
