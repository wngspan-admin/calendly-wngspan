import { WNGSPAN_BRAND } from "./brand";
...
export const WEBSITE_URL = ensureProtocol(WNGSPAN_BRAND.websiteUrl);
export const APP_NAME = WNGSPAN_BRAND.appName;
export const SUPPORT_MAIL_ADDRESS = WNGSPAN_BRAND.supportEmail;
export const COMPANY_NAME = WNGSPAN_BRAND.companyName;
export const SENDER_ID = WNGSPAN_BRAND.senderId;
export const SENDER_NAME = WNGSPAN_BRAND.senderName;
...
export const LOGO = WNGSPAN_BRAND.logos.wordmark;
export const LOGO_DARK = WNGSPAN_BRAND.logos.wordmarkDark;
export const LOGO_ICON = WNGSPAN_BRAND.logos.icon;
export const AVATAR_FALLBACK = "/avatar.svg";
export const FAVICON_16 = WNGSPAN_BRAND.logos.icon;
export const FAVICON_32 = WNGSPAN_BRAND.logos.icon;
export const APPLE_TOUCH_ICON = WNGSPAN_BRAND.logos.icon;
export const MSTILE_ICON = WNGSPAN_BRAND.logos.icon;
export const ANDROID_CHROME_ICON_192 = WNGSPAN_BRAND.logos.icon;
export const ANDROID_CHROME_ICON_256 = WNGSPAN_BRAND.logos.icon;
...
export const DEFAULT_LIGHT_BRAND_COLOR: string = WNGSPAN_BRAND.colors.primary;
export const DEFAULT_DARK_BRAND_COLOR: string = WNGSPAN_BRAND.colors.darkPrimary;
